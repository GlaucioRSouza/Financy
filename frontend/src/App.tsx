  ...
  return (
    <main className="dashboard-page">
      ...
      <section className="dashboard-content">
        ...
        </> : activeTab === 'Categorias' ? <CategoryManager token={token} categories={categories} transactions={transactions} onChanged={loadDashboard} /> : <TransactionsManager token={token} transactions={transactions} categories={categories} onChanged={loadDashboard} onNew={openModal} />}
      </section>
